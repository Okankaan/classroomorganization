...
namespace GProject
{
    ...
    class TimeTableClassR : Activity
    {
        private GridView gv;
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            SetContentView(Resource.Layout.Time_TableClassR);
            gv = FindViewById<GridView>(Resource.Id.gridClassR);
            spinner = FindViewById<Spinner>(Resource.Id.comboClassNamesR);
            classes();
        ...
        void classes()
        {
            try
            {
                ...
                Uri url = new Uri("http://n00ne.xyz/xamarin_facultyclassR.php");
                NameValueCollection parameters = new NameValueCollection();
