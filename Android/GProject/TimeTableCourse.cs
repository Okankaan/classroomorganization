...
namespace GProject
{
    ...
    class TimeTableCourse: Activity
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            SetContentView(Resource.Layout.Time_TableCourse);
            combo_CourseSearch = FindViewById<Spinner>(Resource.Id.comboCourseSearch);
            grid_Course = FindViewById<GridView>(Resource.Id.gridCourse);
        ...
        void courses()
        {
            try
            {
                ...
                Uri url = new Uri("http://n00ne.xyz/xamarin_facultycourses.php");
                NameValueCollection parameters = new NameValueCollection();
