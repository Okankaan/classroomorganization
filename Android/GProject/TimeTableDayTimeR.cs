...
namespace GProject
{
    ...
    class TimeTableDayTimeR : Activity
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            SetContentView(Resource.Layout.Time_TableDayTimeR);
            
            combo_Days = FindViewById<Spinner>(Resource.Id.comboDaysR);
            combo_Times = FindViewById<Spinner>(Resource.Id.comboTimesR);
            grid_DayTime = FindViewById<GridView>(Resource.Id.gridDayTimeR);
            vdays();
        ...
        void vdays()
        {
            ...
            Uri url = new Uri("http://n00ne.xyz/xamarin_dayComboR.php");
        ...
        void vtimes()
        {
            ...
            Uri url = new Uri("http://n00ne.xyz/xamarin_timeComboR.php");
            NameValueCollection parameters = new NameValueCollection();
        ...
        private void Combo_Times_ItemSelected(object sender, AdapterView.ItemSelectedEventArgs e)
        {
            ...
            Uri url = new Uri("http://n00ne.xyz/xamarin_daytimeR.php");
            NameValueCollection parameters = new NameValueCollection();
            parameters.Add("day", tday);
